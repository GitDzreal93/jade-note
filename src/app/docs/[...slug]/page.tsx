...
import ClientBytemdViewer from '@/components/markdown/ClientBytemdViewer';
          ...
          <div className="max-w-none">
            {content ? (
              <div className="mdx-content">
                <ClientBytemdViewer 
                  content={content} 
                  className="prose prose-emerald prose-headings:text-gray-900 prose-h1:text-3xl prose-h2:text-2xl prose-h3:text-xl prose-p:text-gray-600 prose-a:text-emerald-600 prose-a:no-underline hover:prose-a:text-emerald-500 prose-code:text-gray-800 prose-code:bg-gray-100 prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-pre:bg-gray-50 prose-pre:text-gray-800 prose-pre:shadow-lg prose-img:rounded-lg prose-img:shadow-md" 
                />
              </div>
            ) : (
